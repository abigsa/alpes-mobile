...
module.exports = {
  ...
  crear:     w(async(req,res)=>ok(res,await service.crear(req.body),"Categoria creado/a",201)),
  actualizar:w(async(req,res)=>{await service.actualizar(req.params.id,req.body);ok(res,null,"Categoria actualizado/a");}),
  eliminar:  w(async(req,res)=>{await service.eliminar(req.params.id);ok(res,null,"Categoria eliminado/a");}),
