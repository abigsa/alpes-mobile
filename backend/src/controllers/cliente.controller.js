...
module.exports = {
  ...
  crear:     w(async(req,res)=>ok(res,await service.crear(req.body),"Cliente creado/a",201)),
  actualizar:w(async(req,res)=>{await service.actualizar(req.params.id,req.body);ok(res,null,"Cliente actualizado/a");}),
  eliminar:  w(async(req,res)=>{await service.eliminar(req.params.id);ok(res,null,"Cliente eliminado/a");}),
