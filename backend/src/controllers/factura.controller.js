...
module.exports = {
  ...
  crear:     w(async(req,res)=>ok(res,await service.crear(req.body),"Factura creado/a",201)),
  actualizar:w(async(req,res)=>{await service.actualizar(req.params.id,req.body);ok(res,null,"Factura actualizado/a");}),
  eliminar:  w(async(req,res)=>{await service.eliminar(req.params.id);ok(res,null,"Factura eliminado/a");}),
