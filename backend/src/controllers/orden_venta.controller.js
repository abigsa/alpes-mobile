...
module.exports = {
  ...
  actualizarEstado:w(async(req,res)=>{
    const {estado_orden_id, observaciones} = req.body;
    await service.actualizarEstado(req.params.id, estado_orden_id, observaciones);
    ok(res,null,"Estado actualizado");
  }),
