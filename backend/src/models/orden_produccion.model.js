  ...
  try {
    const result = await conn.execute(
      `BEGIN ${PKG}.SP_INSERTAR_ORDEN_PRODUCCION(:p_num_op, :p_producto_id, :p_cantidad_planificada, :p_estado_produccion_id, :p_inicio_estimado, :p_fin_estimado, :p_inicio_real, :p_fin_real, :p_estado, :p_orden_produccion_id); END;`,
      {
        ...
        p_inicio_estimado: data.inicio_estimado ? new Date(data.inicio_estimado + "T12:00:00") : null,
        p_fin_estimado: data.fin_estimado ? new Date(data.fin_estimado + "T12:00:00") : null,
        p_inicio_real: data.inicio_real ? new Date(data.inicio_real + "T12:00:00") : null,
        p_fin_real: data.fin_real ? new Date(data.fin_real + "T12:00:00") : null,
