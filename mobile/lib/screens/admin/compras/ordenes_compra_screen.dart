...
class _OrdenesCompraScreenState extends State<OrdenesCompraScreen> {
  ...
  Future<void> _eliminar(int id) async {
    ...
    if (ok != true) return;
    await http.delete(Uri.parse(ApiConfig.baseUrl + ApiConfig.ordenCompra + '/' + id.toString()));
    _cargar();
  }
...
class _OrdenesCompraForm extends StatefulWidget {
  ...
  const _OrdenesCompraForm({super.key, this.item, required this.onGuardado});
  @override
  ...
  Future<void> _guardar() async {
    ...
    try {
      ...
      if (id != null) {
        ...
        res = await http.put(Uri.parse(ApiConfig.baseUrl + ApiConfig.ordenCompra + '/' + id.toString()),
