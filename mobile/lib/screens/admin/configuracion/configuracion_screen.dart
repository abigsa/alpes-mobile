...
class _ConfiguracionScreenState extends State<ConfiguracionScreen> {
  ...
  void _abrirForm([Map<String,dynamic>? item]) {
    showModalBottomSheet(
      ...
      builder: (_) => _ConfiguracionForm(item: item, onGuardado: _cargar),
    );
  }
...
class __ConfiguracionFormState extends State<_ConfiguracionForm> {
  ...
  void initState() {
    ...
    controllers['rol_id'] = TextEditingController();
  ...
  Future<void> _guardar() async {
    ...
    try {
      ...
      'rol_id': controllers['rol_id']!.text,
        ...
        child: Form(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Text(widget.item == null ? 'Nuevo configuracion' : 'Editar configuracion',
