...
class _SplashScreenState extends State<SplashScreen>
  ...
  void initState() {
    ...
    _textFade = CurvedAnimation(
        parent: _ctrl, curve: const Interval(0.5, 0.9, curve: Curves.easeOut));
  ...
  Future<void> _navigate() async {
    ...
    if (auth.isLoggedIn) {
      ...
      context.go('/home-publica'); // ← redirige al home público
    }
  }
        ...
        body: Container(
          ...
          child: Stack(children: [
            Positioned(
                ...
                right: -80,
                child: _circle(
                    280, AlpesColors.oroGuatemalteco.withOpacity(0.06))),
            Positioned(
                bottom: -80,
                left: -60,
                child: _circle(
                    220, AlpesColors.oroGuatemalteco.withOpacity(0.04))),
            Positioned(
                top: 180,
                left: -30,
                child: _circle(
                    100, AlpesColors.oroGuatemalteco.withOpacity(0.03))),
            Center(
              child: Column(
                    ...
                    child: FadeTransition(
                      ...
                      child: Container(
                        ...
                        child: const Icon(Icons.chair_alt_rounded,
                            size: 56, color: AlpesColors.cafeOscuro),
                      ),
                    ),
                  ),
