...
class _CatalogoScreenState extends State<CatalogoScreen> {
  ...
  final _ordenes = {'nombre': 'Nombre', 'precio_asc': 'Precio ↑', 'precio_desc': 'Precio ↓'};
  ...
  Widget build(BuildContext context) {
    ...
    if (_orden == 'precio_asc') {
      lista = [...lista]..sort((a, b) => (a.precio ?? 0).compareTo(b.precio ?? 0));
    } else if (_orden == 'precio_desc') {
      lista = [...lista]..sort((a, b) => (b.precio ?? 0).compareTo(a.precio ?? 0));
    } else {
              ...
              PopupMenuButton<String>(
                ...
                itemBuilder: (_) => _ordenes.entries.map((e) =>
                    PopupMenuItem(value: e.key,
                        child: Row(children: [
                          Icon(_orden == e.key ? Icons.check_rounded : Icons.circle_outlined,
  ...
  Widget _emptyState() => Center(
    child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
      ...
      const Text('Sin resultados', style: TextStyle(fontSize: 15,
