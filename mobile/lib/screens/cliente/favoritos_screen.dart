      ...
      body: favList.isEmpty
          ? Center(
              child: Column(
                ...
                children: [
                  const Icon(Icons.favorite_outline, size: 80, color: AlpesColors.arenaCalida),
                  const SizedBox(height: 16),
                  Text('Sin favoritos aún', style: Theme.of(context).textTheme.headlineSmall),
                  const SizedBox(height: 8),
                  Text('Guarda productos que te gusten', style: Theme.of(context).textTheme.bodyMedium),
