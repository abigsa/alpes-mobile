    ...
    return Container(
      ...
      child: Stack(children: [
        ...
        Column(children: [
          ...
          _sidebarItem(
              Icons.person_outline_rounded, 'Mi perfil', 'perfil', context,
              route: '/perfil'),
          _sidebarItem(
              Icons.credit_card_rounded, 'Mis tarjetas', 'tarjetas', context,
              route: '/mis-tarjetas'),
          _sidebarItem(
          ...
          _sidebarItem(Icons.grid_view_rounded, 'Catálogo', 'catalogo', context,
              route: '/catalogo'),
          _sidebarItem(Icons.history_rounded, 'Historial', 'historial', context,
              route: '/mis-ordenes'),
          _sidebarItem(
              Icons.notifications_outlined, 'Notificaciones', 'notif', context,
              route: '/notificaciones'),
          _sidebarItem(
              Icons.settings_outlined, 'Configuración', 'config', context,
              route: '/perfil'),
          const Spacer(),
          const Divider(color: Colors.white12, height: 1),
          // User footer
        ...
        Padding(
          ...
          child: Row(children: [
            ...
            badges.Badge(
              ...
              badgeStyle:
                  const badges.BadgeStyle(badgeColor: AlpesColors.rojoColonial),
              child: IconButton(
      ...
      Row(children: [
        Expanded(
            child: _kpiCard(Icons.shopping_bag_rounded, '$_totalPedidos',
                'PEDIDOS TOTALES', AlpesColors.cafeOscuro)),
        const SizedBox(width: 10),
        Expanded(
            child: _kpiCard(Icons.local_shipping_rounded, '$_enCamino',
                'EN CAMINO', AlpesColors.verdeSelva)),
      ]),
      const SizedBox(height: 10),
      Row(children: [
        Expanded(
