                    ...
                    children: [
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              _row('Estado',
                                  '${_orden!['ESTADO'] ?? _orden!['estado']}'),
                              _row('Total',
                                  'Q${_orden!['TOTAL'] ?? _orden!['total']}'),
                              _row('Dirección',
                                  '${_orden!['DIRECCION_ENVIO_SNAPSHOT'] ?? _orden!['direccion_envio_snapshot'] ?? 'N/A'}'),
                            ],
                          ),
                        ),
                      ),
                      ...
                      SizedBox(
                        ...
                        child: OutlinedButton.icon(
                          ...
                          onPressed: () =>
                              context.go('/seguimiento/${widget.ordenId}'),
                        ),
                      ),
                    ],
                  ),
