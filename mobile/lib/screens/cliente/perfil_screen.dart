...
class PerfilScreen extends StatelessWidget {
                    ...
                    Expanded(child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text('@$username',
                              style: const TextStyle(color: AlpesColors.oroGuatemalteco,
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                _menuCard([
                  _MenuItem(Icons.receipt_long_rounded, 'Mis pedidos',
                      'Ver historial de órdenes', () => context.go('/mis-ordenes')),
                  _MenuItem(Icons.favorite_rounded, 'Mis favoritos',
                      'Productos guardados', () => context.go('/favoritos')),
                  _MenuItem(Icons.location_on_rounded, 'Mis direcciones',
                ...
                const SizedBox(height: 10),
                _menuCard([
                  _MenuItem(Icons.person_outline_rounded, 'Editar perfil',
                      'Nombre, email y contraseña', () => _editarPerfil(context, auth)),
                ]),
    ...
    child: Column(
      children: List.generate(items.length * 2 - 1, (i) {
        if (i.isOdd) return const Divider(height: 1, indent: 16,
            endIndent: 16, color: AlpesColors.pergamino);
  ...
  void _editarPerfil(BuildContext context, AuthProvider auth) {
    ...
    final apellidoCtrl = TextEditingController(
        text: '${auth.usuario?['APELLIDO'] ?? auth.usuario?['apellido'] ?? ''}');
        ...
        builder: (ctx, setSt) => Padding(
          ...
          child: Padding(
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              Row(children: [
                Expanded(child: TextField(controller: nombreCtrl,
                    decoration: const InputDecoration(labelText: 'Nombre'))),
                const SizedBox(width: 10),
                Expanded(child: TextField(controller: apellidoCtrl,
