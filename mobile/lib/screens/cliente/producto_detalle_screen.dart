                        ...
                        children: [
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                if (_producto!.precio != null)
                                  Row(children: [
                                    Text(
                                      'Q ${_producto!.precio!.toStringAsFixed(2)}',
                                      style: const TextStyle(
                                          fontSize: 26,
                          ...
                          Container(
                            ...
                            child: Column(children: [
                              _specRow('Material', _producto!.material,
                                  Icons.category_rounded),
                              _specRow('Color', _producto!.color,
                                  Icons.palette_rounded),
                              _specRow('Tipo', _producto!.tipo,
                                  Icons.label_rounded),
                          ...
                          Container(
                            margin:
                                const EdgeInsets.fromLTRB(14, 18, 14, 100),
                        ...
                        child: Row(children: [
                          if (_producto!.precio != null)
                            Column(
                              ...
                              Text(
                                'Q ${(_producto!.precio! * _cantidad).toStringAsFixed(2)}',
                                style: const TextStyle(
                                    fontSize: 18,
                                    fontWeight: FontWeight.w800,
                                    color: AlpesColors.cafeOscuro),
